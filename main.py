...
globals.CLOWN_ROLE_NAME            = str       (os.environ.get("CLOWN_ROLE_NAME")            or "lorem ipsum")
...
globals.RELEASES_FILTER_CHANNELS   = json.loads(os.environ.get("RELEASES_FILTER_CHANNELS")   or "{829394060573540373, 1102620253801947206}")
globals.RELEASES_FILTER_NOTIF_CHAN = json.loads(os.environ.get("RELEASES_FILTER_NOTIF_CHAN") or "{728385295992487986}")
...
async def main():
    ...
    await globals.bot.load_extension('cogs.retools')
